...
| --- | --- |
| `/codex_auth_start` | Starts Hermes' OpenAI Codex device-code auth flow in the background. The helper sends the authorization link as a Telegram button and sends the device code as a separate message for easy copy/paste. |
