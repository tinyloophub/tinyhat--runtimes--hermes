...
REQUIRED_FILES = (
    ...
    "hermes_runtime/commands/install_hermes.py",
    "hermes_runtime/commands/hermes_status.py",
    "hermes_runtime/commands/tinyhat_plugin_status.py",
    "hermes_runtime/commands/check_tinyhat_plugin_update.py",
...
def main() -> None:
    ...
    required_readme_phrases = (
        ...
        "`check_tinyhat_plugin_update`",
        "`install_tinyhat_plugin`",
